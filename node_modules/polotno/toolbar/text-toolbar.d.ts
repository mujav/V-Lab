...
export declare const TextToolbar: (({ store, hideTextFontFamily, hideTextEffects, hideTextSpacing, hideTextBold, hideTextItalic, hideTextUnderline, }: PageProps) => JSX.Element) & {
    displayName: string;
};
