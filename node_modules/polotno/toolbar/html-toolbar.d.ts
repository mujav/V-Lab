...
export declare const HtmlToolbar: (({ store, hideTextFontFamily, hideTextEffects, hideTextSpacing, hideTextBold, hideTextItalic, hideTextUnderline, }: PageProps) => JSX.Element) & {
    displayName: string;
};
export {};
