...
exports.MULTISELECT = "".concat(NS, "-multi-select");
exports.MULTISELECT_POPOVER = "".concat(exports.MULTISELECT, "-popover");
exports.MULTISELECT_TAG_INPUT_INPUT = "".concat(exports.MULTISELECT, "-tag-input-input");
exports.OMNIBAR = "".concat(NS, "-omnibar");
