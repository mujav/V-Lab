...
export class NumericInput extends AbstractPureComponent2 {
    ...
    renderButtons() {
        ...
        return (React.createElement(ButtonGroup, { className: Classes.FIXED, key: "button-group", vertical: true },
            React.createElement(Button, { "aria-label": "increment", "aria-controls": this.numericInputId, disabled: disabled || isIncrementDisabled, icon: "chevron-up", intent: intent, ...this.incrementButtonHandlers }),
            React.createElement(Button, { "aria-label": "decrement", "aria-controls": this.numericInputId, disabled: disabled || isDecrementDisabled, icon: "chevron-down", intent: intent, ...this.decrementButtonHandlers })));
    }
    renderInput() {
